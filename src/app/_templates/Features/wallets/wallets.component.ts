...
export class WalletComponent implements OnInit {
  ...
  public loadAdressData(adress:string){
    ...
    if(adress != ""){
      ...
      this.wallet = {
        adress: adress,
        balance: Number(Math.round(data["balance"] / 10000000000000000) + "e-2"),
        value: Number(Math.round(Number(Math.round(data["balance"] / 10000000000000000) + "e-0") * this._marketComponent.current_price) + "e-2"),
